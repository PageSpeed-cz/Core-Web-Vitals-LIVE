...
.${HUD_ID} .${PREFIX}-options-toggle:focus-visible,
.${HUD_ID} .${PREFIX}-iconbtn:focus-visible,
.${HUD_ID} .${PREFIX}-footer a:focus-visible {
  outline: 2px solid rgba(255, 0, 170, 0.65);
  outline-offset: 3px;
  border-radius: 10px;
}
